    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right mb-2">
                <a class="btn btn-success" onClick="add()" href="javascript:void(0)"> Criar Categorias</a>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="javascript:void(0)" id="CategoriasForm" name="CategoriasForm" class="form-horizontal" method="POST" enctype="multipart/form-data">
...
function add(){
    $('#CategoriasForm').trigger("reset");
    $('#CategoriasModal').html("Add Categorias");
...
function editFunc(id){
    $.ajax({
        ...
        success: function(res){
            $('#CategoriasModal').html("Edit Categorias");
            $('#Categorias-modal').modal('show');
            $('#id').val(res.id);
            $('#Nome').val(res.Nome);
        }
